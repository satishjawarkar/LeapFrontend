...
export const SETUP_NAVIGATION: SetupNavGroup[] = [
  {
    ...
    title: "Loan Setups",
    items: [
      { id: "scheme-setup", label: "Scheme Setup", path: "/setup/scheme-setup" },
      { id: "loan-type-setup", label: "Loan Type Setup", path: "/setup/loan-type-setup" },
      { id: "sector-setup", label: "Sector Setup", path: "/setup/sector-setup" },
      ...
      { id: "district-setup", label: "District Setup", path: "/setup/district-setup" },
      ...
      { id: "course-setup", label: "Course Setup", path: "/setup/course-setup" },
    ],
  },
  {
    id: "grant-setups",
